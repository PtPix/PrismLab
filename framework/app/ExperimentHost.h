...
namespace prism::host
{
    ...
    struct HostServices
    {
        ...
        gpu::TextureCache* targets = nullptr;
        gpu::BufferCache* buffers = nullptr;
    ...
    public:
        ...
        ExperimentTools& GetTools() { return m_Tools; }
    ...
    private:
        ...
        ExperimentTools m_Tools;
        FramePresentation m_Presentation;
