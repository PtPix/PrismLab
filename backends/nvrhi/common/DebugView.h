...
namespace renderlab::gpu
{
    ...
    public:
        ...
        [[nodiscard]] bool IsValid() const { return m_VertexShader && m_PixelShader; }

    private:
        bool EnsurePipeline(nvrhi::ITexture* source, nvrhi::IFramebuffer* target);
        ...
        nvrhi::IFramebuffer* m_BoundTarget = nullptr;
    };
}
