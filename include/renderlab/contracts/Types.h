...
// Contracts layer.
//
// Rules for this directory (see docs/architecture.md):
//   * No Donut scene/app types, no NVRHI objects, no ImGui.
//   * The only external dependency is donut::math, which is the project-wide math library.
//   * Everything here describes semantic meaning, not a specific renderer or engine.
