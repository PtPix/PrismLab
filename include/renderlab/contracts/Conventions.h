...
// Contracts layer: the project-wide semantic conventions, version 1.
//
// These are RenderLab's own rules, not Donut's or UE's defaults. Adapters convert host data into
// these conventions; if a host value is passed through unconverted, the interface metadata must say
// so and the verification code must check it.
//
