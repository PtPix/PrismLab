...
// Contracts layer: the shadow feature contract.
//
// This is the first feature interface, written before its implementation (see docs/architecture.md,
// section 5). It defines what a shadow feature consumes and produces; the NVRHI execution layer
// (backends/nvrhi/shadows) and the algorithm shaders (algorithms/shaders/Shadows) implement it.
//
