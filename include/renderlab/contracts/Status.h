...
// Contracts layer: error reporting without exceptions and without C++23 std::expected.
//
// A lab reports failure with a Status carrying the module name and a reason, so that a failed
// experiment is not silently replaced by a different algorithm (see docs/architecture.md, 4.3).
